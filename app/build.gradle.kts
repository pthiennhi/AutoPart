...
android {
    namespace = "group5.com.prm_autopartssale"
    compileSdk = 34

    defaultConfig {
        applicationId = "group5.com.prm_autopartssale"
        minSdk = 21
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.google.firebase:firebase-database")        //Firebase DB realtime
